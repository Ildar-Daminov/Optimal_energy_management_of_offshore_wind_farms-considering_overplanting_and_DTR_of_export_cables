function [Theta_ct,Theta_Et,Alpha]=losses_partial_transients(I)
...
global R_AC90_eval Ta Tb TA TB a b Lambda1 Lambda2  t De Diff_sol Depth
global Rho_sol Wd
...
Wc=3*I^2*R_AC90_eval;                                                       % or Wc=I^2*R_AC90_eval (without multiplication by 3);

% total I^2*R (ohmic) power loss of each cable
WI=Wc*(1+Lambda1+Lambda2);  % excluding Wd
